...
public class PersistenceTest {
    public static void main(String[] args) {
        ...
        Subcategory subcategory = new SubcategoryDAO(em).getSubcategoryWithJPA("java");
...
//        dao.deleteCourseWithJPA("java-primeiros-passos");
        ...
        em.close();
        publicCourses.forEach(c-> System.out.println(c));
        System.out.println("================================");
        subcategoriesActive.forEach( s -> System.out.println(s));
        System.out.println("=================================");
        categoriesActive.forEach(ct -> System.out.println(ct));
        System.out.println("=================================");
        subcategoriesWithoutDescription.forEach(s -> System.out.println(s));

//        List<Course> allCourses = dao.getAllCourses(em);
//        Question question = new Question("titulo","abc", 1, null ,true,"aaa");
//        em.getTransaction().begin();
//        em.persist(question);
//        em.getTransaction().commit();
//        em.close();
